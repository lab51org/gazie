...
while ($a_row = gaz_dbi_fetch_array($result)) {
    ...
    if ($docref) {
		...
		echo "<a class=\"btn btn-xs btn-default btn-default\" title=\"" . $script_transl['daily_report'] . "\" href=\"../contab/dailyrepcon.php?id_con=" . $a_row['id_tes']. "\" target=\"_blank\"><i class=\"glyphicon glyphicon-th-list\"></a>";
	}
    echo "</td>";
    echo "<td align=\"center\">";
	?>
