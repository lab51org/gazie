<?php
 ...
 --------------------------------------------------------------------------
    ...
    Copyright (C) - Antonio De Vincentiis Montesilvano (PE)
...
<form method="GET">
	...
	<tr>
		...
		<td class="FacetFieldCaptionTD">
			<input type="text" name="des_artico" placeholder="descrizione" class="input-sm form-control" value="<?php echo (isset($des_artico))? $des_artico : ""; ?>" maxlength="15">
        </td>
		<td class="FacetFieldCaptionTD">
...
while ($r = gaz_dbi_fetch_array($result)) {
	...
	?>
	<a class="btn btn-info btn-md" href="javascript:;" onclick="window.open('<?php echo"../../modules/magazz/mostra_lotti.php?codice=".$r['codice'];?>', 'titolo', 'menubar=no, toolbar=no, width=800, height=400, left=80%, top=80%, resizable, status, scrollbars=1, location');"><span class="glyphicon glyphicon-tag"></span></a>
	<?php 
    }	
    echo "</td>\n";
