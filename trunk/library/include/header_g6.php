                ...
                <meta http-equiv="X-UA-Compatible" content="IE=edge">
                    <meta name="viewport" content="width=device-width, initial-scale=1">
                        ...
                        <link rel="shortcut icon" href="../../library/images/favicon.ico">			
                            ...
                            <link href="../../library/style/header/default.css" rel="stylesheet" type="text/css" />
                            <link href="../../library/style/header/skins/default.css" rel="stylesheet" type="text/css" />
                            <link href="../../library/style/header/ml_dropdown.css" rel="stylesheet" type="text/css" />
                            <?php
                            /** ENRICO FEDELE */
...
//aggiornamento automatico della tabella gaz_menu_usage
        ...
        <body role="document">';
                                      ...
                                      /*if (file_exists("../../library/style/header_menu_" . $tipomenu . ".php")) {
                                         ...
                                         require("../../library/style/header/header_menu_g6.php");
                                      //}
                                   }
