...
while ($row = gaz_dbi_fetch_array($result)) {
	...
	$idx=array(0=>array('descri'=>'assets','acc_fixed_assets'=>'assets','id_movcon'=>'assets','clfoco'=>'instal', 'id_customer'=>'contract','vat_section'=>'contract','conclusion_date'=>'contract','start_date'=>'contract','periodicity'=>'contract','idinstallazione'=>'assist')); 
	foreach($idx as $vi){
		foreach($vi as $k=>$v){
