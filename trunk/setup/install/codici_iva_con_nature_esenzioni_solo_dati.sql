...
INSERT INTO `gaz_001aliiva` (`codice`,`descri`, `fae_natura`, `tipiva`, `aliquo`) VALUES
	...
	(@lastcodice+53,'Art.17 c.5 DPR 633/72', 'N6.2', 'R', 22.0),
	(@lastcodice+54,'Art.17 c.6 lett.a bis DPR 633/72', 'N6.4', 'R', 22.0),
	(@lastcodice+55,'Art.74 c. 7 e 8 DPR 633/72', 'N6.1', 'R', 22.0),
	(@lastcodice+56,'Art.17 c.6 lett. a DPR 633/72', 'N6.3', 'R', 22.0),
	(@lastcodice+57,'Art.17 c.6 lett. b DPR 633/72', 'N6.5', 'R', 22.0),
	(@lastcodice+58,'Art.17 c.6 lett. c DPR 633/72', 'N6.6', 'R', 22.0),
	(@lastcodice+59,'Art.17 c.6 lett. a ter DPR 633/72', 'N6.7', 'R', 22.0),
	(@lastcodice+60,'Art.17 c.6 lett. d bis,d ter,d quater DPR 633/72', 'N6.8', 'R', 22.0),
	(@lastcodice+61,'Art.7 bis DPR 633/72 (cessioni beni UE)', 'N6.9', 'R', 22.0),
	(@lastcodice+62,'Art.7 ter acquisti UE DPR 633/72', 'N6.9', 'R', 22.0),
	(@lastcodice+63,'Art.7 quater DPR 633/72 prest.serv.(acquisti)', 'N6.9', 'R', 22.0),
	(@lastcodice+64,'Art.7 quinquies DPR 633/72 prest.serv.(acquisti)', 'N6.9', 'R', 22.0),
	(@lastcodice+65,'art.40 c. 3 e 4 e art.41 DL 331/93', 'N7', 'S',0);
