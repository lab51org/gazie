...
INSERT INTO `gaz_admin_config` (`adminid`, `var_descri`, `var_name`, `var_value`) SELECT Login , 'Contenuto in HTML del testo del corpo delle email inviate dell\'utente', 'body_send_doc_email', '<h3><span style="color: #000000">La presente e-mail per trasmetterVi i documenti che troverete in allegato.</span></h3>' FROM `gaz_admin`;
