...
class PreventivoCliente extends Template
{
    ...
    function newPage() {
        ...
        if ( !getCalcTotVal() ) {
            ...
            $this->Cell(9,6,'Qtà',1,0,'R',1);
            $this->Cell(9,6,'Kg',1,0,'R',1);
            $this->Cell(16,6,'Prezzo',1,0,'R',1);
        }        
            ...
            if ($this->GetY() >= 185) {
                ...
                case "0":
                    ...
                    if ( !getCalcTotVal() ) {
                        ...
                        $this->Cell(9, 6, gaz_format_quantity($rigo['quanti'],1,$this->decimal_quantity),1,0,'R');
                        $this->Cell(9, 6, gaz_format_quantity($rigo['quanti2'],1,$this->decimal_quantity),1,0,'R');
                        $this->Cell(16, 6, number_format($rigo['prelis'],$this->decimal_price,',',''),1,0,'R');
                    }
