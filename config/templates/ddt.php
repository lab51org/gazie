...
class DDT extends Template_con_scheda {
   ...
   function setTesDoc() {
      ...
      $tmp = DateTime::createFromFormat('Y-m-d', $this->tesdoc['data_ordine']); // siccome in realtà è una data in foprmato USA, la converto in data
      $this->data_ordine = $tmp->format('d/m/Y'); // e poi la trasformo in stringa nel formato italiano
      /** fine modifica FP */
   }
   ...
   function pageFooter() {
      ...
      $this->SetY(220);
      $this->SetFont('helvetica', '', 9);
      /** inizio modifica FP 22/10/2015 */
      if ($this->tesdoc['tipdoc'] == 'DDT') {
         $this->Cell(60, 5, 'Causale', 'LTR', 0, 'C', 1);
         $this->Cell(23, 5, 'Data Ordine', 'LTR', 0, 'C', 1);
      }
// rimossa      $this->Cell(83, 5, 'Agente', 'LTR', 0, 'C', 1);
...
// rimossa      $this->Cell(83, 5, $this->agente, 'LR');
      if ($this->tesdoc['tipdoc'] == 'DDT') {
         $this->Cell(60, 5, $this->caumag['descri'], 'LBR', 0, 'C', 0, '', 1);
         $this->Cell(23, 5, $this->data_ordine, 'LBR', 0, 'C', 0, '', 1);
      } else {
         $this->Cell(60, 5, "", 'LBR', 0, 'C', 0, '', 1);
         $this->Cell(23, 5, "", 'LBR', 0, 'C', 0, '', 1);
      }
      /** fine modifica FP */
      ...
      /** inizio modifica FP 22/10/2015 */
//rimossa         $this->Cell(187, 5, 'Pagamento - Banca', 'LTR', 1, 'C', 1);
//rimossa         $this->Cell(187, 5, $this->pagame['descri'] . ' ' . $this->banapp['descri'], 'LBR', 1, 'C', 0, '', 1);
      $this->Cell(60, 5, 'Agente', 'LTR', 0, 'C', 1);
      $this->Cell(127, 5, 'Pagamento - Banca', 'LTR', 1, 'C', 1);
      $this->Cell(60, 5, $this->agente, 'LR');
      $this->Cell(127, 5, $this->pagame['descri'] . ' ' . $this->banapp['descri'], 'LBR', 1, 'C', 0, '', 1);
      /** fine modifica FP */
