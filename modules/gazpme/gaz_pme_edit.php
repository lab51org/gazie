...
$select_tab=array();
$tables = gaz_dbi_query ("SHOW TABLES FROM ".$Database." LIKE '".$table_prefix.'_'."%'");// ottengo le tabelle in un unico array associativo
$cnt=0;
...
echo '<br />';
echo "<div align=\"center\" class=\"FacetFormHeaderFont\"><a href=\"http://www.phpmyedit.org/\">".$script_transl['msg2'];
echo "</a></div>\n";
?>
</body>
</html>
