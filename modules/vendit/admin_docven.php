...
// This is in the PHP file and sends a Javascript toast to the client
...
*/
//rimossa   echo "</td></tr></table>\n";
echo "</td></tr>";
echo "<tr>\n";
// raggruppamento bolle
echo "<td align=\"left\" class=\"FacetFieldCaptionTD\" title=\"" . $script_transl['ragbol_title'] . "\">$script_transl[59]" . "</td>\n";
...
// data ordine
echo "<td class=\"FacetFieldCaptionTD\">$script_transl[60]</td><td class=\"FacetDataTD\">\n";
// select del giorno
echo "\t <select name=\"gioemi\" class=\"FacetSelect\" >\n";
for ($counter = 1; $counter <= 31; $counter++) {
   $selected = "";
...
echo "\t </select></td>";
// da_fatturare
echo "<td align=\"left\" class=\"FacetFieldCaptionTD\" title=\"" . $script_transl['da_fatturare_title'] . "\">$script_transl[61]" . "</td>\n";
echo "<td class=\"FacetDataTD\" title=\"" . $script_transl['da_fatturare_title'] 
        . "\"><input type=\"checkbox\" name=\"da_fatturare\" maxlength=\"6\" size=\"1\""
        .($form['da_fatturare']?"checked=\"checked\"":"")
        . " /></td>\n";
echo "</tr></table>\n";
/** fine modifica FP*/
...
if ($calc->total_exc >= $admin_aziend['taxstamp_limit'] && $form['virtual_taxstamp'] > 0 && $form['taxstamp'] < 0.01) {
