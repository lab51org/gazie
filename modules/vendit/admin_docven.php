...
//echo "<td class=\"FacetDataTD\" title=\"" . $script_transl['ragbol_title'] . "\"><input type=\"text\" value=\"" . $form['ragbol'] . "\" name=\"ragbol\" maxlength=\"6\" size=\"1\" onchange=\"this.form.submit()\" /></td>\n";
   ...
   echo "</td>";
// data ordine
   echo "<td class=\"FacetFieldCaptionTD\">$script_transl[59]</td><td class=\"FacetDataTD\">\n";
// select del giorno
...
// select del anno
   ...
   echo "\t </select></td>";
// da_fatturare
   echo "<td align=\"left\" class=\"FacetFieldCaptionTD\" title=\"" . $script_transl['da_fatturare_title'] . "\">$script_transl[60]" . "</td>\n";
