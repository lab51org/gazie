            ...
            if ($toDo == 'update') { // e' una modifica
                ...
                switch ($form['tipdoc']) {
                    ...
                    case "DDY": // triangolazione
                        ...
                        break;
                    case "CMR":
                        $sql_documento = "YEAR(datemi) = " . $form['annemi'] . " AND( tipdoc like 'CMR' or tipdoc = 'FAC') and seziva = $sezione";
                        $where = "numdoc DESC";
                        $sql_protocollo = " 0";
                        break;
                    case "FAI":
					...
					if ($form['ok_barcode']!="ok"){
						...
						<div class="col-sm-12 col-md-1 col-lg-1">
							<div class="form-group text-center">
								<button type="submit"  name="button_ok_barcode" title="inserisci con pistola Barcode"> 
