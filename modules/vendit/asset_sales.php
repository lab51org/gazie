...
if ((isset($_POST['Insert'])) || ( isset($_POST['Update']))) {   //se non e' il primo accesso
    ...
    $cliente = $anagrafica->getPartner(intval($_POST['clfoco']));
    ...
    if ($form['change_pag'] != $form['pagame']) {  //se è stato cambiato il pagamento
        ...
        if (($new_pag['tippag'] == 'B' or $new_pag['tippag'] == 'T' or $new_pag['tippag'] == 'V')
            ...
            if ($toDo == 'update') {  //se è una modifica mi baso sulle vecchie spese
                ...
                if ($old_header['speban'] > 0 and $cliente['speban'] == "S") {
                    $form['speban'] = 0;
                } elseif ($old_header['speban'] == 0 and $cliente['speban'] == "S") {
                    $form['speban'] = 0;
                } else {
                    $form['speban'] = 0.00;
                }
...
// --- fine controlli
        if (count($msg['err']) == 0) {// nessun errore
            if ($toDo == 'update') { // e' una modifica
                ...
                $form['acc_fixed_assets'] = lastAccount($form['id'], $form['ss_amm_min']);
                ...
                $import = $form['import'];
                // rigo conto cliente con importo totale
...
<?php if ($toDo == 'update') {
    ?>
            $("#datreg,#numfat,#datfat,#id,#mas_found_assets,#mas_cost_assets,#codvat,#seziva,#clfoco").prop("disabled", true);
    <?php
}
?>
    });
    ...
    <div class="panel panel-default">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6 col-md-3 col-lg-3">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 text-left"><?php echo $cliente['indspe'] . ' ' . $cliente['citspe']; ?></div>                
                    </div>
                </div>
                <div class="col-sm-6 col-md-3 col-lg-3">
                    <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-3 col-lg-3">
                    <div class="form-group">
                        <label for="id" class="col-sm-4 control-label"><?php echo $script_transl['id']; ?></label>
                        <div>
                            <?php
                            $gForm->selectAsset('id', $form['id'], "col-sm-8 small");
                            ?>
                        </div>
                    </div>
                </div>
