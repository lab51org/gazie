<?php
/* $Id: select_evaord.php,v 1.68 2011/01/01 11:07:53 devincen Exp $
 --------------------------------------------------------------------------
...
echo "\t </select>\n";
echo "</td></tr><tr>\n";
echo "\t<td class=\"FacetFieldCaptionTD\">".$script_transl['traspo'].' '.$money[1]."</td>\n";
...
if (! empty ($form['righi'])) {
   ...
   foreach ($form['righi'] as $k => $v) {
    ...
    echo "<td colspan=\"2\" class=\"FacetFieldCaptionTD\" align=\"right\">".$script_transl['taxable']." $money[2] &nbsp;\n";
