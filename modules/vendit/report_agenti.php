<?php
/*$Id: report_agenti.php,v 1.21 2011/01/01 11:07:53 devincen Exp $
 --------------------------------------------------------------------------
...
while ($a_row = gaz_dbi_fetch_array($result)) {
        echo "<tr><td class=\"FacetDataTD\" align=\"center\"><a href=\"admin_agenti.php?id_agente=".$a_row['id_agente']."&Update\">".$a_row['id_agente']."</a></td>";
        ...
        echo "<td class=\"FacetDataTD\" align=\"center\"><a href=\"select_provvigioni.php?id_agente=".$a_row['id_agente']."\"><img src=\"../../library/images/stampa.gif\" border=\"0\" /></a></td>";
        echo "<td class=\"FacetDataTD\" align=\"center\">".$a_row["base_percent"]." &nbsp;</td>";
        echo "<td class=\"FacetDataTD\" align=\"center\"><a href=\"delete_agenti.php?id_agente=".$a_row['id_agente']."\"><img src=\"../../library/images/x.gif\" alt=\"Cancella\" border=\"0\" /></a></td>";
        echo "</tr>\n";
}
?>
</form>
