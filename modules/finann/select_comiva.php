...
<form method="POST">
    ...
    <table border="0" cellpadding="3" cellspacing="1" class="FacetFormTABLE" align="center">
        ...
        print "<tr><td class=\"FacetDataTD\"> CD3 </td><td class=\"FacetDataTD\">" . $script_transl[38] . "</td><td class=\"FacetDataTD\"><input type=\"text\" value=\"" . round($form['oroimp']) . "\" maxlength=\"11\"  name=\"oroimp\"></td><td class=\"FacetDataTD\">" . $script_transl[39] . "</td><td class=\"FacetDataTD\"><input type=\"text\" value=\"" . round($form['oroiva']) . "\" maxlength=\"11\"  name=\"oroiva\"></td></tr>\n";
        print "<tr><td colspan=\"5\" class=\"FacetFieldCaptionTD\">-- " . str_pad($script_transl[37], 120, '-') . "</td></tr>\n";
        print "<tr><td class=\"FacetDataTD\"> CD3 </td><td class=\"FacetDataTD\">" . $script_transl[38] . "</td><td class=\"FacetDataTD\"><input type=\"text\" value=\"" . round($form['rotimp']) . "\" maxlength=\"11\"  name=\"rotimp\"></td><td class=\"FacetDataTD\">" . $script_transl[39] . "</td><td class=\"FacetDataTD\"><input type=\"text\" value=\"" . round($form['rotiva']) . "\" maxlength=\"11\"  name=\"rotiva\"></td></tr>\n";
