        ...
        <table class="Tlarge table table-striped table-bordered table-condensed table-responsive">
            ...
            while ($r = gaz_dbi_fetch_array($result)) {
				...
				if (intval($r['codcon']) > 0){
					?>
					<button title="Collaboratore non cancellabile perchÈ ha movimenti contabili" class="btn btn-xs btn-default btn-elimina disabled"><i class="glyphicon glyphicon-trash"></i></button>
					<?php
				} else {
				?>
