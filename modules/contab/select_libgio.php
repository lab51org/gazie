...
echo "<tr class=\"FacetFooterTD\"><td><td align=\"right\"><input type=\"submit\" class=\"btn btn-info\" title=\"Se il libro giornale ha molte pagine c'è il rischio di mandare in timeout il sever!\" name=\"stampa_a_mese\" value=\"".$script_transl['print']." PDF/A mese per mese (lento)\" > &nbsp; <input  class=\"btn btn-info\" type=\"submit\" title=\"Se il libro giornale ha molte pagine c'è il rischio di mandare in timeout il sever!\" name=\"stampa_a\" value=\"".$script_transl['print']." PDF/A (lento)\" ></td> &nbsp;</td><td align=\"right\" colspan=2><input type=\"submit\" class=\"btn btn-info\" name=\"stampa\" value=\"".$script_transl['print']." PDF (veloce)\" ></td></tr>";
?>
</table>
