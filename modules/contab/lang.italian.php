...
$strScript = array("select_liqiva.php" =>
    ...
    "select_spesometro_analitico.php" =>
    array('title' => "Comunicazione periodica analitica delle operazioni IVA ",
        'descri_value' => array('M' => 'del mese di ', 'T' => 'del trimestre '),
        'min_limit' => "Limite massimo operazioni s/fattura",
        'datini' => "Data inizio periodo",
        'datfin' => "Data fine periodo",
        ...
        'err' => array(
            ...
            'date' => 'La data di inizio periodo è successiva a quella di fine',
        ),
        'total' => "Totali",
