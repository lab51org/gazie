<div class="breadcrumbs">    
    ...
    <ul class="breadcrumb">
        <li>
            <a href="<?php echo BASE_URL.'/'.DEFAULT_FILE; ?>"><i class="glyphicon glyphicon-home glyphicon-white"></i></a>
        </li>
        <?php $i = 0; ?>
    ...
    <div id="source">
        <?php if (ENABLE_EDITING): ?>
            <div class="alert alert-info">
                <i class="glyphicon glyphicon-pencil"></i> <strong>Stai modificando l'argomento</strong>. Usa il tasto "Salva cambiamenti" per confermare le modifiche effettuate.
            </div>
        <?php endif ?>
