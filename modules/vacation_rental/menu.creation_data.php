...
$update_db[]="ALTER TABLE ".$gTables['rental_events']." ADD `voucher_id` INT(11) NULL DEFAULT NULL COMMENT 'Se valorizzato indica il Riferimento ID discounts usato' AFTER `id_rigbro`";
?>
