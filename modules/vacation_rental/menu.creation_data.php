...
$update_db[]="CREATE TABLE `".$dbname."`.".$table_prefix."_XXXrental_extra ( `id` INT(2) NOT NULL AUTO_INCREMENT , `mod_prezzo` INT(1) NOT NULL , `rif_alloggio` VARCHAR(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL , `max_quantity` INT NOT NULL DEFAULT '0' , PRIMARY KEY (`id`)) ENGINE = MyISAM; ";
...
$update_db[]="INSERT INTO ".$table_prefix."_XXXcompany_config (`description`, `var`, `val`) VALUES ('Notti da bloccare prima e dopo ogni prenotazione', 'vacation_blockdays', '0')";
$update_db[]="INSERT INTO ".$table_prefix."_XXXcompany_config (`description`, `var`, `val`) VALUES ('Notti minime da prenotare ', 'vacation_minnights', '1')";
