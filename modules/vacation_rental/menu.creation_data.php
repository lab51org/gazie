...
$update_db[]="CREATE TABLE `".$table_prefix."_XXXrental_extra` ( `id` INT(2) NOT NULL AUTO_INCREMENT , `mod_prezzo` INT(1) NOT NULL , `rif_alloggio` VARCHAR(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL , `max_quantity` INT NOT NULL DEFAULT '0' , PRIMARY KEY (`id`)) ENGINE = MyISAM; ";
...
$update_db[]="ALTER TABLE ".$table_prefix."_XXXrental_extra ADD `rif_facility` INT(9) NOT NULL COMMENT 'riferimento ad id_artico_group' AFTER `obligatory`;";
?>
