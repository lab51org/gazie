...
$tn = array('rental_events','rental_prices','rental_ical','rental_extra','rental_discounts');
$idaz = 1;
...
$update_db[]="INSERT INTO ".$gTables['company_config']." (`id`, `description`, `var`, `val`) VALUES (NULL, 'ID pagamento con bonifico bancario per front-end (sincronizzazione con pagamenti GAzie)', 'vacation_id_pagbon', '0'), (NULL, 'ID pagamento con carta di credito off-line per front-end (sincronizzazione con pagamenti GAzie)', 'vacation_id_pagccoff', '0') ";
