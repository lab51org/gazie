...
$update_db[]="INSERT INTO ".$gTables['company_config']." (`id`, `description`, `var`, `val`) VALUES (NULL, 'URL front-end del regolamento locazioni', 'vacation_url_rules', NULL), (NULL, 'URL front-end del regolamento sulla privacy', 'vacation_url_privacy', NULL), (NULL, 'URL front-end pagina di accesso utente', 'vacation_url_user', NULL) ";
