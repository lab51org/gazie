...
$strScript = array(
    ...
    array('title' => 'Modulo di prenotazione',
		...
		'persons' => ' persone',
		'adults' => 'adulti',
		'children' => 'bambini fino a 12 anni ',
		'price' => 'prezzo',
		'each' => 'cadauno',
		...
		'which_deposit' => 'di cui, per caparra confirmatoria',
		...
		'amount' => 'Importo',
		'bank_reason' => 'Causale: Caparra confirmatoria locazione ',
  ...
  "admin_extra.php" =>
    ...
    'oggetto' => 'Oggetto',
    'body2' => 'Il locatore concede in locazione al conduttore, che accetta, per il solo ed esclusivo uso turistico abitativo: ',
    ...
    'divieto5' => 'Il locatore consegnerà l\'alloggio in buono stato di pulizia e manutenzione. Il conduttore accetta e si obbliga che le pulizie durante il soggiorno, così come quelle finali alla partenza, saranno a sua cura e carico.',
    'divieto6' => 'Il mancato rispetto, da parte del conduttore, anche di un solo punto del presente contratto comporta la risoluzione espressa ipso iure del presente contratto ai sensi dell\'art. 1456 del C.C.',
    'durata1' => 'Il presente contratto è stipulato a tempo determinato, per la durata massima di notti ',
    'durata2' => 'L\'arrivo (check-in) è stabilito e accettato dal conduttore fra le ore 15 e le 19 del giorno ',
    'durata3' => 'La partenza (check-out) è stabilita e accettata dal conduttore fra le ore 8 le 10 del giorno ',
    'durata4' => ' e la presente locazione cesserà senza bisogno di disdetta alcuna, che si intende data ora per allora, con obbligo del conduttore di restituire l\'alloggio al locatore.',
    'durata5' => 'Non sono ammessi arrivi o partenze fuori dalla fascia oraria stabilita.',
    'canone1' => 'Il canone della presente locazione, convenuto ed accettato da entrambe le parti, è di Euro',
    'canone2' => ' comprensivo delle spese per i consumi di luce, acqua e gas. Il conduttore accetta e si obbliga a corrispondere il saldo della locazione contestualmente al ritiro delle chiavi il giorno di arrivo.',
    'canone3' => 'A titolo di garanzia, al check-in il conduttore accetta di dover versare in contanti un deposito cauzionale infruttifero di Euro ',
    ...
    'recesso5' => 'Il locatore può recedere dal presente contratto nei 29 giorni che precedono la data di arrivo. In tale caso restituirà la caparra confirmatoria ricevuta oltre ad un ulteriore importo di pari importoa titolo di indennizzo e risarcimento.',
    ...
    'recesso7' => 'Qualora a causa di eventi straordinari (a solo titolo di esempio: incendio, terremoti, allagamenti etc) il conduttore sarà costretto a terminare anticipatamente la locazione, il locatore restituirà l\'importo delle notti non godute. Nessun altro danno potrà essere richiesto al locatore.',
    'recesso8' => 'In mancanza di disdetta, la mancata presentazione del conduttore alla data di arrivo e nella fascia oraria stabilita comporterà la risoluzione espressa ipso iure del presente contratto ai sensi dell\'art. 1456 del C.C. e l\'obbligo del pagamento del saldo della locazione.',
    'accettazione' => 'Accettazione',
    'accettazione1' => 'Il presente contratto è stato letto accettato e sottoscritto on-line con la spunta sull\'apposita casella. Sarà pertanto valido a tutti gli effetti anche in mancanza della firma fisica.',
