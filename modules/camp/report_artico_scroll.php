    ...
    while ($row = gaz_dbi_fetch_array($result)) {
        ...
        <tr>      
            ...
            <td data-title="<?php echo $script_transl["stock"]; ?>" title="Visualizza scheda prodotto">
			   ...
			   ?>
			   <a  class="btn btn-info btn-md" href="javascript:;" onclick="window.open('<?php echo"../../modules/camp/mostra_lotti.php?codice=".$row['codice'];?>', 'titolo', 'menubar=no, toolbar=no, width=800, height=400, left=80%, top=80%, resizable, status, scrollbars=1, location');">
