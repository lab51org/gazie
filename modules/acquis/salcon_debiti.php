<?php
/*$Id: salcon_debiti.php,v 1.46 2011/01/01 11:07:17 devincen Exp $
 --------------------------------------------------------------------------
...
if($_POST['num_rigo'] > 0) {
    ...
    if ($toDo == 'update') {
        ...
        echo '<input title="Inserisci il movimento contabile e la ricevut di pagamento" type="submit" value="INSERISCI !" accesskey="i" name="ins">';
    }
    echo "</td></tr>\n";
}
