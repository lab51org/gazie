<?php
/* $Id: admin_bank_account.php,v 1.16 2011/01/01 11:07:28 devincen Exp $
 --------------------------------------------------------------------------
...
if ($toDo == 'update') {
   print '<input type="submit" accesskey="m" name="ins" value="'.strtoupper($script_transl['update']).'!"></td></tr><tr></tr>';
} else {
   print '<input type="submit" accesskey="i" name="ins" value="'.strtoupper($script_transl['insert']).'!"></td></tr><tr></tr>';
}
print "</td></tr></table>\n";
?>
</form>
