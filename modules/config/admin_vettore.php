<?php
/* $Id: admin_vettore.php,v 1.10 2011/01/02 13:25:34 devincen Exp $
 --------------------------------------------------------------------------
...
if ($toDo == 'update') {
                echo '<input title="'.$script_transl['upd'].'" type="submit" name="ins" value="'.strtoupper($script_transl['update']).'!">';
} else {
                echo '<input title="'.$script_transl['ins'].'" type="submit" name="ins" value="'.strtoupper($script_transl['insert']).'!">';
}
echo "\t </td>\n";
echo "</tr>\n";
echo "</table>\n";
