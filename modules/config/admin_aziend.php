...
echo "</tr>\n";
echo "<tr>\n";
echo "<td class=\"FacetFieldCaptionTD\">" . $script_transl['mas_fixed_assets'] . "</td><td colspan=\"2\" class=\"FacetDataTD\">\n";
$gForm->selectAccount('mas_fixed_assets', $form['mas_fixed_assets'] . '000000', array(1, 9));
echo "</td>\n";
echo "</tr>\n";
echo "<tr>\n";
echo "<td class=\"FacetFieldCaptionTD\">" . $script_transl['mas_found_assets'] . "</td><td colspan=\"2\" class=\"FacetDataTD\">\n";
$gForm->selectAccount('mas_found_assets', $form['mas_found_assets'] . '000000', array(2, 9));
echo "</td>\n";
echo "</tr>\n";
echo "<tr>\n";
echo "<td class=\"FacetFieldCaptionTD\">" . $script_transl['mas_cost_assets'] . "</td><td colspan=\"2\" class=\"FacetDataTD\">\n";
$gForm->selectAccount('mas_cost_assets', $form['mas_cost_assets'] . '000000', array(3, 9));
echo "</td>\n";
echo "</tr>\n";
echo "<tr>\n";
