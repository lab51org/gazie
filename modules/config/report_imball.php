...
while ($a_row = gaz_dbi_fetch_array($result)) {
    ...
    echo "<td align=\"center\"><a class=\"btn btn-xs btn-edit\" href=\"admin_imball.php?Update&codice=".$a_row["codice"]."\"><i class=\"glyphicon glyphicon-edit\"></i>&nbsp;".$a_row["codice"]."</a> &nbsp</td>";
