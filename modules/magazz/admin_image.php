    ...
    if (isset($_POST['Submit'])) { // conferma tutto
		...
		if (empty($msg)) { // nessun errore
          ...
          if ($_FILES['userfile']['error']==0) {
            move_uploaded_file($_FILES["userfile"]["tmp_name"], DATA_DIR . "files/".$admin_aziend['company_id']."/" . $form['id_doc'] . "." . $form['extension']);
          }
		...
		unlink ("../../data/files/".$admin_aziend['company_id']."/" . $form['id_doc'] . "." . $form['extension']);
		header("Location: ".$form['ritorno']);
        exit;
	}
