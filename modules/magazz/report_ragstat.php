...
while ($a_row = gaz_dbi_fetch_array($result)) {
    ...
    echo "<tr>";
    echo "<td class=\"FacetDataTD\" $boxover><a class=\"btn btn-xs btn-default\" href=\"admin_ragstat.php?Update&codice=".$a_row["codice"]."\"><i class=\"glyphicon glyphicon-edit\"></i>&nbsp;".$a_row["codice"]."</a> </td>";
    ...
    echo "<td class=\"FacetDataTD\"><a class=\"btn btn-xs btn-default btn-elimina\" href=\"delete_ragstat.php?codice=".$a_row["codice"]."\"><i class=\"glyphicon glyphicon-remove\"></i></a></td>";
    echo "</tr>\n";
}
?>
</table>
