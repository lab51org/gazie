...
CREATE TABLE `gaz_menu_usage` ( `adminid` varchar(30) NOT NULL, `name` varchar(50) NOT NULL, `link` varchar(255) NOT NULL CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, `click` int(5) DEFAULT NULL, `last_use` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (`link`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8;
