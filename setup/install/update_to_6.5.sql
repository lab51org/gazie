...
CREATE TABLE IF NOT EXISTS `gaz_menu_usage` ( `adminid` varchar(30) NOT NULL, `link` varchar(50) NOT NULL DEFAULT '', `click` int(5) DEFAULT NULL, `last_use` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,  PRIMARY KEY (`adminid`), KEY `click` (`click`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8;
