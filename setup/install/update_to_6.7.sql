...
ALTER TABLE `gaz_XXXtesdoc`	CHANGE COLUMN `initra` `initra` TIMESTAMP NOT NULL AFTER `volume`;
ALTER TABLE `gaz_XXXtesbro`	CHANGE COLUMN `initra` `initra` TIMESTAMP NOT NULL AFTER `volume`;
