...
CREATE TABLE IF NOT EXISTS `gaz_XXXlotmag` (  `id` INT NOT NULL AUTO_INCREMENT,  `id_purchase` INT NOT NULL, `lot_or_serial` VARCHAR(100) NOT NULL, `description` VARCHAR(100) NOT NULL,  `id_doc` INT NOT NULL,  `expiry` DATE NOT NULL,  PRIMARY KEY (`id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
