...
ALTER TABLE `gaz_country` ADD `black_list` INT NOT NULL; 
...
ALTER TABLE `gaz_menu_script` CHANGE `id` `id` INT NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `gaz_XXXtesbro` CHANGE `numdoc` `numdoc` BIGINT NOT NULL;
