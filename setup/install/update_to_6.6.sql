...
CREATE TABLE gaz_XXXagenti_forn (`id_agente` INT NOT NULL,`id_fornitore` INT NOT NULL,`base_percent` decimal(4,2) NOT NULL,`tipo_contratto` TINYINT NOT NULL,`adminid` VARCHAR(20) NOT NULL,`last_modified` TIMESTAMP NOT NULL DEFAULT NOW() ON UPDATE CURRENT_TIMESTAMP) ENGINE=MyISAM DEFAULT CHARSET=utf8;
