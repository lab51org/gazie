...
ALTER TABLE `gaz_XXXcaumag`	ADD PRIMARY KEY (`codice`);
INSERT INTO `gaz_XXXcaumag` (`codice`, `descri`, `clifor`, `insdoc`, `operat`, `last_modified`) VALUES (82, 'CARICO DA PRODUZIONE', '0', '0', '1', '2018-11-30 16:54:45'),(81, 'SCARICO PER PRODUZIONE', 0, 0, -1, '', '2016-01-26 15:09:25');
