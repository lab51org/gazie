...
CREATE TABLE IF NOT EXISTS `gaz_XXXassets` ( `id` int(9) NOT NULL AUTO_INCREMENT, `id_tes` int(9) NOT NULL DEFAULT '0',`descri` varchar(100) NOT NULL, `id_tesdoc` int(9) NOT NULL DEFAULT '0', `ss_amm_min` int(2) NOT NULL DEFAULT '0', `valamm` decimal(5,2) NOT NULL DEFAULT '0.00', `acc_fixed_assets` int(9) NOT NULL DEFAULT '0', `acc_found_assets` int(9) NOT NULL DEFAULT '0', `acc_cost_assets` int(9) NOT NULL DEFAULT '0', `id_no_deduct_vat` int(2) NOT NULL DEFAULT '0', `no_deduct_vat_rate` decimal(5,2) NOT NULL DEFAULT '0.00', `acc_no_detuct_cost` int(11) NOT NULL DEFAULT '0', `no_deduct_cost_rate` decimal(5,2) NOT NULL DEFAULT '0.00', PRIMARY KEY (`id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8;
