...
CREATE TABLE IF NOT EXISTS `gaz_XXXassets` ( `id` int(9) NOT NULL AUTO_INCREMENT, `id_tes` int(9) NOT NULL DEFAULT '0', `id_tesdoc` int(9) NOT NULL DEFAULT '0', `ss_amm_min` int(2) NOT NULL DEFAULT '0', `valamm` decimal(5,2) NOT NULL DEFAULT '0.00', `acc_fixed_assets` int(9) NOT NULL DEFAULT '0', `acc_found_assets` int(9) NOT NULL DEFAULT '0', `acc_cost_assets` int(9) NOT NULL DEFAULT '0', PRIMARY KEY (`id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8;
