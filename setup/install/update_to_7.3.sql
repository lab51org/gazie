...
INSERT INTO `gaz_admin_config` (`id`, `adminid`, `var_descri`, `var_name`, `var_value`) VALUES(1, 'amministratore', 'Contenuto in HTML del testo del corpo delle email inviate dell\'utente', 'body_send_doc_email', '<h3><span style="color: #000000">La presente e-mail per trasmetterVi i documenti che troverete in allegato.</span></h3>');
INSERT INTO `gaz_admin_config` (`id`, `adminid`, `var_descri`, `var_name`, `var_value`) VALUES(2, 'amministratore', 'Menu/header/footer personalizzabile', 'theme', 'g7');
