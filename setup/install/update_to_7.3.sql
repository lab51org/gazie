...
INSERT INTO `gaz_admin_config` (`adminid`, `var_descri`, `var_name`, `var_value`) SELECT Login , 'Contenuto in HTML del testo del corpo delle email inviate dell\'utente', 'body_send_doc_email', 'Tel. interno: 123' FROM `gaz_admin`;
