...
CREATE TABLE `gaz_XXXpaymov` ( `id` int(9) NOT NULL AUTO_INCREMENT, `id_paymovcon` int(9) NOT NULL, `id_docmovcon` int(9) NOT NULL, `amount` decimal(11,2) NOT NULL, PRIMARY KEY (`id`) ) ENGINE=MyISAM ;
