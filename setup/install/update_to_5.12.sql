...
CREATE TABLE `gaz_XXXpaymov` ( `id` INT NOT NULL AUTO_INCREMENT, `id_paymovcon` INT NOT NULL, `id_docmovcon` INT NOT NULL, `amount` decimal(11,2) NOT NULL, `expiry` DATE NOT NULL, PRIMARY KEY (`id`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8;
