...
INSERT INTO `gaz_XXXcompany_config` SELECT MAX(id)+1, 'SMTP Secure', 'smtp_secure (tls,ssl)', ''  FROM `gaz_XXXcompany_config`;
INSERT INTO `gaz_XXXcompany_config` SELECT MAX(id)+1, 'SMTP Authentication (mail,smtp,sendmail,qmail)', 'smtp_auth', 'smtp'  FROM `gaz_XXXcompany_config`;
