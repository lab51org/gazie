...
while ($row = gaz_dbi_fetch_array($result)) {
	...
	$idx=array(0=>array('codice_composizione'=>'distinta_base','codice_artico_base'=>'distinta_base','id_movmag'=>'distinta_base')); // indicizzo la colonna data di registrazione dei movimenti contabili per poter avere libro giornale e partitari velocemente
	foreach($idx as $vi){
		foreach($vi as $k=>$v){
