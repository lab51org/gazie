...
INSERT INTO `gaz_menu_script` SELECT MAX(id)+1, 9, 'select_analisi_fatturato_clienti.php', '', '', 43, '', 5  FROM `gaz_menu_script`;
INSERT INTO `gaz_menu_script` SELECT MAX(id)+1, 9, 'select_analisi_fatturato_clienti_fornitori.php', '', '', 44, '', 6  FROM `gaz_menu_script`;
