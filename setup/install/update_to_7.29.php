...
while ($row = gaz_dbi_fetch_array($result)) {
	...
	// inizio controlli presenza di indici, ne ricontrollo molti in quanto in passato un bug in fase di creazione nuova azienda li perdevacompromettendo gravemente la performance di molte query 
