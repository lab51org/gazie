...
INSERT INTO `gaz_menu_script` SELECT MAX(id)+1, 9, 'select_esportazione_articoli_venduti.php', '', '', 40, '', 3  FROM `gaz_menu_script`;
...
ALTER TABLE `gaz_XXXclfoco` ADD `sel4esp_art` BOOLEAN DEFAULT false;
