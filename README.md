...
* Gestione del Magazzino a lotti
* Produzione
...
### Utente Finale
È disponibile un Help in linea all'interno del programma ed il supporto tramite ticket a questo [link](https://sourceforge.net/projects/gazie/support)

### Sviluppatori
Maggiori dettagli su documentazione ed il supporto agli sviluppatori è disponibile a questo [ link ](https://sourceforge.net/projects/gazie/support)
