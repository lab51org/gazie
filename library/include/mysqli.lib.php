...
function movmagInsert($newValue) {
  $table = 'movmag';
  $columns = array('caumag','operat','datreg','tipdoc','desdoc','datdoc','clfoco','scochi','id_rif','artico','id_wharehouse','id_lotmag','id_orderman','id_assets','quanti','prezzo','scorig','campo_impianto','custom_field','status','adminid');
  $newValue['adminid'] = $_SESSION["user_name"];
  $last_id=tableInsert($table, $columns, $newValue);
